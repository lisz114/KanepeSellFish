...
public class EnvioDeEmail {
	 ...
	 */
	public EnvioDeEmail () { //Para o GMAIL 
	 ...
	 */
	public EnvioDeEmail (String mailSMTPServer, String mailSMTPServerPort) { //Para outro Servidor
	...
	public void sendMail(String from, String to, String subject, String message) {
		...
		auth = new SimpleAuth ("benjamim.sb03@aluno.ifsc.edu.br.com","Miau2233");
		...
		try {
			 ...
			 */
			tr.connect(mailSMTPServer, "benjamim.sb03@aluno.ifsc.edu.br", "Miau2233");
