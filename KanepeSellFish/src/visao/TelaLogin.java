...
public class TelaLogin extends JFrame {
	...
	public TelaLogin() {
		...
		panel_1.setLayout(new MigLayout("", "[][][][grow][][][][][][]",
				"[100px][50px][][50px][][][][][][][][][][grow][][][grow][][grow][][][][][][]"));
		...
		gl_panel_3.setHorizontalGroup(
				gl_panel_3.createParallelGroup(Alignment.TRAILING).addGroup(gl_panel_3.createSequentialGroup()
						.addGap(21).addComponent(lblTelaLogin, GroupLayout.DEFAULT_SIZE, 321, Short.MAX_VALUE)));
		gl_panel_3.setVerticalGroup(gl_panel_3.createParallelGroup(Alignment.TRAILING).addGroup(Alignment.LEADING,
				gl_panel_3.createSequentialGroup().addContainerGap().addComponent(lblTelaLogin)
		...
		bntEntrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TelaInicioVendedor telaVendedor = new TelaInicioVendedor();
