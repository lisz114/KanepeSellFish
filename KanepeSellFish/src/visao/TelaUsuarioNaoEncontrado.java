...
public class TelaUsuarioNaoEncontrado extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaUsuarioNaoEncontrado frame = new TelaUsuarioNaoEncontrado();
	 ...
	 * Create the frame.
	 */
	public TelaUsuarioNaoEncontrado() {
		setResizable(false);
		...
		JLabel lblNewLabel = new JLabel("Usuário não encontrado");
